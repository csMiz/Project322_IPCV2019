...
''' <summary>
''' week 8: revised viola-jones detector
''' </summary>
Module W8
                    ...
                    For i = 0 To 10 - w
                        ...
                        If w Mod 2 = 0 Then
                            ...
                            With tmpHaar1
                                ...
                                .Height = h
                                .HaarType = 0
                                .Direction = 0    'left white right black
                                .SetRect()
                            End With
                            ...
                            With tmpHaar2
                                ...
                                .Height = h
                                .HaarType = 0
                                .Direction = 1    'left black right white
                                .SetRect()
                            End With
                        ...
                        If h Mod 2 = 0 Then
                            ...
                            With tmpHaar1
                                ...
                                .Height = h
                                .HaarType = 0
                                .Direction = 2    'up white bottom black
                                .SetRect()
                            End With
                            Dim tmpHaar2 As New MyHaarLikeFeature
                            With tmpHaar2
                                ...
                                .Height = h
                                .HaarType = 0
                                .Direction = 3    'up black bottom black
                                .SetRect()
                            End With
                            HaarFeatureList.Add(tmpHaar1)
                            HaarFeatureList.Add(tmpHaar2)
                        End If
                        'extension of curve shape
                        Dim tmpCurveHaar1 As New MyHaarLikeFeature
                        With tmpCurveHaar1
                            .X = i
                            .Y = j
                            .Width = w
                            .Height = h
                            .HaarType = 3
                            .Direction = 0    'opening down
                            .SetRect()
                        End With
                        HaarFeatureList.Add(tmpCurveHaar1)
                        Dim tmpCurveHaar2 As New MyHaarLikeFeature
                        With tmpCurveHaar1
                            .X = i
                            .Y = j
                            .Width = w
                            .Height = h
                            .HaarType = 3
                            .Direction = 1    'opening up
                            .SetRect()
                        End With
                        HaarFeatureList.Add(tmpCurveHaar2)
                    Next
                Next
            Next
        Next
    ...
    Private Class MyHaarLikeFeature
        ...
        Public HaarType As Integer  '0,1,2,3

        Public Direction As Integer  '0,1

        Public Rect1 As MyRect
        Public Rect2 As MyRect
        Public Rect3 As MyRect
        Public Rect4 As MyRect
        ...
        Public Sub SetRect()
            If HaarType = 0 Then    '2-rect
                ...
                If Direction = 0 Then    'left white
                ...
                ElseIf Direction = 1 Then    'left black
                    Dim midX As Integer = Width / 2 + X - 1
                    Dim bottomY As Integer = Y + Height - 1
                    Dim topY As Integer = Y - 1
                    Dim leftX As Integer = X - 1
                ...
                ElseIf Direction = 2 Then    'up white
                ...
                ElseIf Direction = 3 Then    'up black
                    Dim midY As Integer = Height / 2 + Y - 1
                    Dim bottomY As Integer = Y + Height - 1
                    Dim topY As Integer = Y - 1
                    Dim leftX As Integer = X - 1
            ...
            ElseIf HaarType = 3 Then
                ...
                If Direction = 0 Then
                    ...
                    Dim leftX As Integer = X - 1
                    Dim rightX As Integer = X + Width - 1
                    Dim midleftX As Integer = Width / 3 + X - 1
                    Dim midrightX As Integer = Width * 2 / 3 + X - 1

                    Rect1 = New MyRect(leftX, topY, midleftX, midY)
                    Rect2 = New MyRect(midrightX, topY, rightX, midY)
                    Rect3 = New MyRect(midleftX, topY, midrightX, midY)
                    Rect4 = New MyRect(leftX, midY, rightX, bottomY)
                Else
                    Dim midY As Integer = Height / 2 + Y - 1
                    Dim bottomY As Integer = Y + Height - 1
                    Dim topY As Integer = Y - 1
                    ...
                    Rect3 = New MyRect(leftX, topY, midleftX, midY)
                    Rect4 = New MyRect(midrightX, topY, rightX, midY)
                    Rect1 = New MyRect(midleftX, topY, midrightX, midY)
                    Rect2 = New MyRect(leftX, midY, rightX, bottomY)
                End If
            End If
        ...
        Public Function GetRect3() As Rectangle
            Return New Rectangle(Rect3.X1, Rect3.Y1, Rect3.X2 - Rect3.X1, Rect3.Y2 - Rect3.Y1)
        End Function

        Public Function GetRect4() As Rectangle
            Return New Rectangle(Rect4.X1, Rect4.Y1, Rect4.X2 - Rect4.X1, Rect4.Y2 - Rect4.Y1)
        End Function
    End Class
